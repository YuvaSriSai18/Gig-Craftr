...
const FreelancerCard = ({ freelancer }: { freelancer: Freelancer }) => (
  ...
  >
    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      >
        {freelancer.rate} · {freelancer.jobSuccess} · {freelancer.projects} · {freelancer.location || 'Remote'}
      </Typography>
      <Box sx={{ display: 'flex', alignItems: 'center', mt: 1 }}>
        ...
        <Typography
          variant="body2"
          sx={{ ml: 1, fontSize: { xs: '20px', sm: '22px' }, color: 'text.primary' }} // Increased font size for rating text
        >
          {freelancer.rating}
        </Typography>
