...
const jobs = [
    ...
    {
        title: 'C++ Developer',
        description: 'I want a C++ Developer who has strong foundation in data structures.',
        time: '12 minutes ago',
        bid: '$200',
        rating: 3.5,
    },
    {
        ...
        description: 'Need an experienced Full Stack Developer to build e-commerce website.',
        time: '19 minutes ago',
        bid: '$100',
        rating: 4.0,
    },
    {
        title: 'C Developer',
        description: 'I want a C Developer to help with an embedded system project.',
        time: '20 minutes ago',
        bid: '$500',
        rating: 4.2,
    },
...
const CarouselSection: React.FC = () => {
    ...
    return (
        <Container sx={{ marginTop: '5rem', position: 'relative' }}>
            <Typography variant="h3" sx={{ fontWeight: 'bold', marginBottom: '2rem', textAlign: 'center' }}>
                Recently Posted Jobs
            </Typography>
            <Box sx={{ position: 'relative', overflow: 'hidden' }}>
                <Grid container alignItems="center" justifyContent="center" spacing={3}>
                    <Grid item xs={1} sx={{ position: 'absolute', top: '50%', left: '10px', transform: 'translateY(-50%)' }}>
                                ...
                                >
                                    <CardContent>
                                        ...
                                        <Typography variant="body1" color="textSecondary" sx={{ marginTop: '0.5rem' }}>
                                            <StarIcon sx={{ color: '#ffb400', fontSize: '20px' }} /> {job.rating}
                                        </Typography>
                                        <Typography variant="body1" color="textSecondary">
                                            {job.time} | {job.bid}
                                        </Typography>
                    ...
                    <Grid item xs={1} sx={{ position: 'absolute', top: '50%', right: '10px', transform: 'translateY(-50%)' }}>
